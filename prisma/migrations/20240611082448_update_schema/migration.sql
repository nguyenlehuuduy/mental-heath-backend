...
CREATE TABLE `FavoriteTag` (
    `id` VARCHAR(191) NOT NULL,
    `nameFavorite` VARCHAR(191) NOT NULL,
    `descriptionFavorite` VARCHAR(191) NOT NULL,
...
CREATE TABLE `Target` (
    ...
    `actionUserId` VARCHAR(191) NOT NULL,
...
-- CreateTable
CREATE TABLE `_AccountToNotification` (
    `A` VARCHAR(191) NOT NULL,
    `B` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `_AccountToNotification_AB_unique`(`A`, `B`),
    INDEX `_AccountToNotification_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `_AccountToFavoriteTag` (
    `A` VARCHAR(191) NOT NULL,
    `B` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `_AccountToFavoriteTag_AB_unique`(`A`, `B`),
    INDEX `_AccountToFavoriteTag_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ActionUser` ADD CONSTRAINT `ActionUser_accountId_fkey` FOREIGN KEY (`accountId`) REFERENCES `Account`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Target` ADD CONSTRAINT `Target_targetAccountId_fkey` FOREIGN KEY (`targetAccountId`) REFERENCES `Account`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Target` ADD CONSTRAINT `Target_actionUserId_fkey` FOREIGN KEY (`actionUserId`) REFERENCES `ActionUser`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `_AccountToNotification` ADD CONSTRAINT `_AccountToNotification_A_fkey` FOREIGN KEY (`A`) REFERENCES `Account`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_AccountToNotification` ADD CONSTRAINT `_AccountToNotification_B_fkey` FOREIGN KEY (`B`) REFERENCES `Notification`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_AccountToFavoriteTag` ADD CONSTRAINT `_AccountToFavoriteTag_A_fkey` FOREIGN KEY (`A`) REFERENCES `Account`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_AccountToFavoriteTag` ADD CONSTRAINT `_AccountToFavoriteTag_B_fkey` FOREIGN KEY (`B`) REFERENCES `FavoriteTag`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
