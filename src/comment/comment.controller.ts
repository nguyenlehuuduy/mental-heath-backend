...
export class CommentController {
  ...
  async createComment(
    ...
    const authorPost = await this.postService.getDetailPostById(commentForCreate.postId);
    if (!!followings.find(item => item.id === authorPost.accountId) || req?.user?.id === authorPost.accountId) {
